...
inline constexpr int ADDRESS_BAR_HEIGHT = 35;
...
/**
 * Story: Standard horizontal and vertical padding (HORIZONTAL_STEP,
 * VERTICAL_STEP) added to the document root to prevent content from touching
 * the edges.
 */
inline constexpr int HORIZONTAL_STEP = 20;
inline constexpr int VERTICAL_STEP = 20;
